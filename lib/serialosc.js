...
module.exports = prime({
  ...
  oscOut: function() {
    if (!this._attributes.oscClient || (this._attributes.oscClient && (this._attributes.oscClient.port) != this._attributes.listenPort || this._attributes._oscClient.host != this._attributes.listenHost)) {
