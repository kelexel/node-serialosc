...
module.exports = prime({
   ...
   this._attributes.eventEmitter.emit(addr, msg);
    ...
    switch(addr) {
      ...
      case '/sys/port':
        ...
        this._oscOut('/sys/port', this._attributes.listenPort);
      ...
      case '/sys/info':
        ...
        this._oscOut('/sys/id', this._attributes.serialoscId);
        this._oscOut('/sys/size', this._attributes.sizeX, this._attributes.sizeY);
        this._oscOut('/sys/host', this._attributes.listenHost);
        this._oscOut('/sys/port', this._attributes.listenPort);
        this._oscOut('/sys/prefix', this._attributes.prefix);
        this._oscOut('/sys/rotation', this._attributes.rotation);
        break;
  ...
  _oscOut: function() {
    if (!this._attributes.oscClient || this._attributes.oscClient.port != this._attributes.listenPort || this._attributes.this._oscClient.host != this._attributes.listenHost) {
